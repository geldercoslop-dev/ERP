SELECT 'BLOCKED_BY_ARCHITECTURE' AS ERROR;
-- ⚠️ CONTROLADO PELO DRIZZLE
-- NÃO EXECUTAR EM PRODUÇÃO
-- USO SOMENTE COM APROVAÇÃO DO ARQUITETO
-- REMOVA ESTA LINHA PARA EXECUTAR: SELECT 'BLOCKED_BY_ARCHITECTURE' AS ERROR;
