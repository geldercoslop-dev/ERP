...
# Verificar se há processos usando as portas 3000, 3001, 3002 e 3000
$ports = @(3000, 3001, 3002, 3000)
...
if (-not $foundProcesses) {
    Write-Host "Nenhum processo encontrado usando as portas 3000, 3001, 3002 ou 3000." -ForegroundColor Green
}
