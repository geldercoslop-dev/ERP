...
// node_modules/.pnpm/@welldone-software+why-did-you-render@10.0.1_react@19.2.4/node_modules/@welldone-software/why-did-you-render/dist/whyDidYouRender.js
var require_whyDidYouRender = __commonJS({
  "node_modules/.pnpm/@welldone-software+why-did-you-render@10.0.1_react@19.2.4/node_modules/@welldone-software/why-did-you-render/dist/whyDidYouRender.js"(exports, module) {
    (function(global2, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory(require_react(), require_lodash()) : typeof define === "function" && define.amd ? define(["react", "lodash"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, global2.whyDidYouRender = factory(global2.react, global2.lodash));
    })(exports, (function(React, lodash) {
      "use strict";
      ...
      var REACT_MEMO_TYPE = hasSymbol$1 ? Symbol["for"]("react.memo") : 60115;
      var REACT_FORWARD_REF_TYPE = hasSymbol$1 ? Symbol["for"]("react.forward_ref") : 60112;
      ...
      var isReactElement = function isReactElement2(object) {
      ...
      var dependenciesMap = /* @__PURE__ */ new WeakMap();
      function accumulateDeepEqualDiffs(a, b, diffsAccumulator) {
        var pathString = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "";
        var _ref = arguments.length > 4 ? arguments[4] : void 0, detailed = _ref.detailed;
        if (a === b) {
          if (detailed) {
        ...
        if (_typeof(a) === "object" && _typeof(b) === "object" && Object.getPrototypeOf(a) === Object.getPrototypeOf(b)) {
          ...
          var relevantKeys = allKeys.filter(function(key2) {
            if (key2 === "stack" && lodash.isError(a)) {
              return false;
            }
            if (isGetter(a, key2)) {
              return false;
      ...
      function calculateDeepEqualDiffs(a, b, initialPathString) {
        var _ref2 = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, _ref2$detailed = _ref2.detailed, detailed = _ref2$detailed === void 0 ? false : _ref2$detailed;
        try {
          var diffs = [];
      ...
      function printDiff(value1, value2, _ref) {
        var pathString = _ref.pathString, consoleLog = _ref.consoleLog;
        ...
        Object.entries(lodash.groupBy(lodash.sortBy(diffs, "pathString"), "diffType")).forEach(function(_ref2) {
          var _ref3 = _slicedToArray(_ref2, 2), diffType = _ref3[0], diffs2 = _ref3[1];
          consoleLog("%c".concat(diffTypesDescriptions[diffType], ":"), "text-decoration: underline; color: blue;");
          diffs2.forEach(function(diff) {
      ...
      function logDifference(_ref) {
        var Component = _ref.Component, displayName = _ref.displayName, hookName = _ref.hookName, prefixMessage = _ref.prefixMessage, diffObjType = _ref.diffObjType, differences = _ref.differences, values = _ref.values;
        if (differences && differences.length > 0) {
          ...
          differences.forEach(function(_ref2) {
            var pathString = _ref2.pathString, diffType = _ref2.diffType, prevValue = _ref2.prevValue, nextValue = _ref2.nextValue;
            function diffFn() {
      ...
      function defaultNotifier(updateInfo) {
        var Component = updateInfo.Component, displayName = updateInfo.displayName, hookName = updateInfo.hookName, prevOwner = updateInfo.prevOwner, nextOwner = updateInfo.nextOwner, prevProps = updateInfo.prevProps, prevState = updateInfo.prevState, prevHookResult = updateInfo.prevHookResult, nextProps = updateInfo.nextProps, nextState = updateInfo.nextState, nextHookResult = updateInfo.nextHookResult, reason = updateInfo.reason;
          ...
          if (prevOwnerData && nextOwnerData) {
            ...
            if (reason.ownerDifferences.hookDifferences) {
              reason.ownerDifferences.hookDifferences.forEach(function(_ref3, i) {
                var hookName2 = _ref3.hookName, differences = _ref3.differences;
      ...
      function getDefaultProps(type) {
        return type.defaultProps || type.type && getDefaultProps(type.type) || type.render && getDefaultProps(type.render) || void 0;
      }
      var emptyObject = {};
      function findObjectsDifferences(userPrevObj, userNextObj) {
        var _ref = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, _ref$shallow = _ref.shallow, shallow = _ref$shallow === void 0 ? true : _ref$shallow;
      ...
      function getOwnerDifferences(prevOwner, nextOwner) {
        ...
        try {
          ...
          var hookDifferences = prevOwnerDataHooks.map(function(_ref, i) {
            var hookName = _ref.hookName, result = _ref.result;
            return {
              hookName,
      ...
      function getUpdateInfo(_ref2) {
        var Component = _ref2.Component, displayName = _ref2.displayName, hookName = _ref2.hookName, prevOwner = _ref2.prevOwner, nextOwner = _ref2.nextOwner, prevProps = _ref2.prevProps, prevState = _ref2.prevState, prevHookResult = _ref2.prevHookResult, nextProps = _ref2.nextProps, nextState = _ref2.nextState, nextHookResult = _ref2.nextHookResult;
        return {
          Component,
          displayName,
          hookName,
      ...
      function patchClassComponent(ClassComponent, _ref) {
        var displayName = _ref.displayName, defaultProps = _ref.defaultProps;
        var WDYRPatchedClassComponent = (function(_ClassComponent) {
          function WDYRPatchedClassComponent2(props, context) {
            var _this;
            _classCallCheck(this, WDYRPatchedClassComponent2);
            _this = _callSuper(this, WDYRPatchedClassComponent2, [props, context]);
            _this._WDYR = {
              renderNumber: 0
            };
            var origRender = _superPropGet(WDYRPatchedClassComponent2, "render", _this, 1) || _this.render;
            var renderIsABindedFunction = origRender !== ClassComponent.prototype.render;
            if (renderIsABindedFunction) {
              _this.render = function() {
                WDYRPatchedClassComponent2.prototype.render.apply(_this);
                return origRender();
              };
            }
            return _this;
          }
          _inherits(WDYRPatchedClassComponent2, _ClassComponent);
          return _createClass(WDYRPatchedClassComponent2, [{
            key: "render",
            value: function render() {
              ...
              return _superPropGet(WDYRPatchedClassComponent2, "render", this, 1) ? _superPropGet(WDYRPatchedClassComponent2, "render", this, 3)([]) : null;
            }
          }]);
        })(ClassComponent);
        try {
      ...
      var getFunctionalComponentFromStringComponent = function getFunctionalComponentFromStringComponent2(componentTypeStr) {
      ...
      function patchFunctionalOrStrComponent(FunctionalOrStringComponent, _ref) {
        var isPure = _ref.isPure, displayName = _ref.displayName, defaultProps = _ref.defaultProps;
      ...
      function createPatchedComponent(Component, _ref2) {
        var displayName = _ref2.displayName, defaultProps = _ref2.defaultProps;
      ...
      function getPatchedComponent(Component, _ref3) {
        var displayName = _ref3.displayName, defaultProps = _ref3.defaultProps;
      ...
      function trackHooksIfNeeded() {
        ...
        if (wdyrStore.options.trackHooks && hooksSupported) {
          var nativeHooks = Object.entries(hooksConfig).map(function(_ref4) {
            var _ref5 = _slicedToArray(_ref4, 2), hookName = _ref5[0], hookTrackingConfig = _ref5[1];
          ...
          hooksToTrack.forEach(function(_ref6) {
            var _ref7 = _slicedToArray(_ref6, 3), hookParent = _ref7[0], hookName = _ref7[1], _ref7$ = _ref7[2], hookTrackingConfig = _ref7$ === void 0 ? {} : _ref7$;
            ...
            var newHook = function useWhyDidYouRenderReWrittenHook() {
              ...
              var dependenciesPath = hookTrackingConfig.dependenciesPath, dontReport = hookTrackingConfig.dontReport;
      ...
      function whyDidYouRender(React2, userOptions) {
        if (React2.__IS_WDYR__) {
          return;
        }
        React2.__IS_WDYR__ = true;
        Object.assign(wdyrStore, {
          React: React2,
          options: normalizeOptions(userOptions),
          origCreateElement: React2.createElement,
          origCreateFactory: React2.createFactory,
          origCloneElement: React2.cloneElement,
          componentsMap: /* @__PURE__ */ new WeakMap()
        });
        React2.createElement = function(origType) {
          ...
          if (WDYRType) {
            try {
              ...
              var element = wdyrStore.origCreateElement.apply(React2, [WDYRType].concat(rest));
          ...
          return wdyrStore.origCreateElement.apply(React2, [origType].concat(rest));
        };
        Object.assign(React2.createElement, wdyrStore.origCreateElement);
        React2.createFactory = function(type) {
          var factory = React2.createElement.bind(null, type);
          factory.type = type;
          return factory;
        };
        Object.assign(React2.createFactory, wdyrStore.origCreateFactory);
        React2.cloneElement = function() {
          wdyrStore.ownerBeforeElementCreation = getCurrentOwner();
          for (var _len3 = arguments.length, args = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
            args[_key3] = arguments[_key3];
          }
          var element = wdyrStore.origCloneElement.apply(React2, args);
          if (wdyrStore.options.logOwnerReasons) {
            storeOwnerData(element);
          }
          return element;
        };
        Object.assign(React2.cloneElement, wdyrStore.origCloneElement);
        trackHooksIfNeeded();
        React2.__REVERT_WHY_DID_YOU_RENDER__ = function() {
          Object.assign(React2, {
...
export default require_whyDidYouRender();
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=@welldone-software_why-did-you-render.js.map
