 ...
 */
import type { users, vendedores, clientes, cores, produtos, produtoVariacoes, gruposPrecificacao, promocoes, promocoesItens, pedidos, itensPedido, cargas, pedidosCarga, pendencias, boletos, pagamentosBoleto, comissoes, planoContas, contasFixas, contasPagar, contasReceber, caixaMensal, configuracoes, counters, schemaVersion } from "../../drizzle/schema";
export type { users, vendedores, clientes, cores, produtos, produtoVariacoes, gruposPrecificacao, promocoes, promocoesItens, pedidos, itensPedido, cargas, pedidosCarga, pendencias, boletos, pagamentosBoleto, comissoes, planoContas, contasFixas, contasPagar, contasReceber, caixaMensal, configuracoes, counters, schemaVersion, };
