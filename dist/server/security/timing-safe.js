 ...
 */
export function constantTimeCompareBuffer(a, b) {
    if (a.length !== b.length) {
        return false;
    }
 ...
 */
export function safePasswordCompare(plainPassword, storedPassword) {
 ...
 */
export async function secureHash(password, saltRounds = 12) {
 ...
 */
export async function secureVerify(password, hash) {
