    ...
    async create(input) {
        ...
        try {
            ...
            console.log(`[ProductTool] Produto criado com sucesso:`, {
                id: typeof data === 'object' && data !== null && 'id' in data ? data.id : 'unknown',
                timestamp: new Date().toISOString()
            });
            return result;
        }
    ...
    async list(input) {
        ...
        try {
            ...
            console.log(`[ProductTool] Listagem concluída:`, {
                count: typeof data === 'object' && data !== null && 'items' in data && Array.isArray(data.items) ? data.items.length : 0,
                timestamp: new Date().toISOString()
            });
            return result;
        }
