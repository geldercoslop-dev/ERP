 ...
 */
export function globalTimeoutMiddleware(timeoutMs = 10000) {
    return (req, res, next) => {
 ...
 */
export function databaseTimeout(timeoutMs = 5000) {
 ...
 */
export function externalApiTimeout(timeoutMs = 8000) {
    return (target, propertyKey, descriptor) => {
        const originalMethod = descriptor.value;
        descriptor.value = async function (...args) {
            const timeout = new Promise((_, reject) => {
