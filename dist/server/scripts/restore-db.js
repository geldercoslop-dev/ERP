...
function getDbConfig() {
    ...
    if (!host || !user || password === undefined || !database) {
        throw new Error("[restore-db] Credenciais obrigatórias. Defina DATABASE_URL ou todas: DB_HOST, DB_USER, DB_PASSWORD, DB_NAME.");
    }
    return {
        host,
...
function log(traceId, level, message, extra) {
