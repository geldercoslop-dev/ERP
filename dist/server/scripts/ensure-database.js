...
function getConnectionConfig() {
    ...
    if (!host || !user || password === undefined) {
        throw new Error("Credenciais obrigatórias. Defina DATABASE_URL ou DB_HOST, DB_USER, DB_PASSWORD (DB_NAME será definido automaticamente).");
    }
    return {
        host,
...
function updateEnvDbName(chosenDb) {
