 ...
 */
export function monitorQuery(query, fn, tenantId) {
...
export function wrapDatabaseConnection(connection) {
    ...
    if (boundQuery) {
        connection.query = function (query, ...rest) {
            const q = typeof query === "string" ? query : String(query);
            const tenant = tenantIdFromFirstArg(rest) ?? this.tenantId;
