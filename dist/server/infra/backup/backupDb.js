...
function getDbConfig() {
    ...
    if (!host || !user || password === undefined || !database) {
        throw new InfrastructureError("[backupDb] Credenciais obrigatórias. Defina DATABASE_URL ou todas: DB_HOST, DB_USER, DB_PASSWORD, DB_NAME.");
    }
    return {
        host,
...
function logBackup(traceId, level, message, extra) {
...
function applyRetention(backupsDir, retentionCount) {
