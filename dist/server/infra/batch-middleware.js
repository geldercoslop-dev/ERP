 ...
 */
export function batchLimiterMiddleware(maxSize = 50) {
    return async ({ ctx, next }) => {
 ...
 */
export function batchTimeoutMiddleware(timeoutMs = 100) {
    return async ({ ctx, next }) => {
...
export function batchingMiddleware(options = {}) {
    const { maxSize = 50, timeout = 100, enableLogging = true, } = options;
    const middlewares = [
