...
export function createRedisSpan(operation, key) {
...
export async function measureDatabaseOperation(operation, query, fn) {
...
export async function measureRedisOperation(operation, key, fn) {
