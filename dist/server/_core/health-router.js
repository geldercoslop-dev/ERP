...
function checkSystemHealth() {
    ...
    return {
        ...
        cpu: {
            status: 'healthy', // TODO: Implementar verificação real de CPU
            loadAverage: [],
            usage: 0
        }
    };
 ...
 */
function calculateOverallStatus(dbHealth, systemHealth) {
...
export const healthRouter = router({
    ...
    check: publicProcedure
        ...
        const startTime = Date.now();
        try {
            systemLogger.info({ message: 'Starting comprehensive health check' });
