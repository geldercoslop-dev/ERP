 ...
 */
export async function requireTenant(ctx) {
    if (!ctx.tenantId) {
        throw new TRPCError({
            code: "UNAUTHORIZED",
 ...
 */
export async function validateOwnership(resourceTenantId, userTenantId) {
 ...
 */
export function withTenant(tenantId, tableName) {
    return {
        tenantId,
