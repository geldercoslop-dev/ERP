import { checkDatabasePoolHealth, getPoolStatsSnapshot } from "../config/database.js";
...
export function createDbGateMiddleware(options = {}) {
    const { failureThreshold = Number(process.env.DB_CIRCUIT_FAILURE_THRESHOLD) || 12, recoveryTimeout = Number(process.env.DB_CIRCUIT_RECOVERY_MS) || 30_000, monitoringPeriod = Number(process.env.DB_CIRCUIT_MONITORING_MS) || 120_000, } = options;
    let failures = 0;
...
export function dbCircuitBreakerMiddleware(opts) {
