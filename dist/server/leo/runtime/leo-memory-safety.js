...
export class LeoMemorySafety {
     ...
     */
    static validateMemoryInput(input) {
     ...
     * Valida importância
     */
    static validateImportance(importance) {
     ...
     */
    static generateIntegrityHash(entry) {
     ...
     */
    static verifyIntegrity(entry, expectedHash) {
     ...
     */
    static validateMemoryType(type) {
        const validTypes = ['event', 'decision', 'insight', 'pattern', 'alert', 'strategy'];
 ...
 */
export function withMemorySafety(operation, context) {
