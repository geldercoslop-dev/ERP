...
import { leoDesktopSandbox } from '../security/leo-desktop-sandbox.js';
...
export class LeoComputerControl {
     ...
     */
    async executarComando(command, args, usuario) {
        const startTime = Date.now();
        try {
     ...
     */
    async abrirArquivo(filePath, usuario) {
        const startTime = Date.now();
        try {
     ...
     */
    async listarArquivos(dirPath, usuario) {
        const startTime = Date.now();
        try {
     ...
     */
    async executarScriptSistema(scriptName, usuario) {
        const scriptsMapeados = {
     ...
     */
    async logAction(usuario, acao, alvo, dados) {
        try {
