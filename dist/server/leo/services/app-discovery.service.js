 ...
 */
function extractScreenInfo(filePath, fileName) {
    try {
 ...
 */
async function registerScreen(_screen) {
    return;
}
/**
 ...
 */
export async function discoverApps(query) {
    try {
 ...
 * Busca tela por rota.
 */
export async function getScreenByRoute(_route) {
    try {
        return null;
    }
    catch (error) {
