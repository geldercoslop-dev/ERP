...
// Stub que retorna valores válidos — LEO ISOLADO
const leoLongMemory = {
    getMemoriesByType: (_tenantId, _type, _limit) => [],
    getRecentMemories: (_tenantId, _limit) => [],
    getCriticalInsights: (_limit) => [],
};
...
export const leoApiRouter = router({
    ...
    ask: protectedProcedure
        ...
        try {
            ...
            const { answer, processingTime } = await askLeoQuestion(tenantId, input.question, input.context);
            return {
                success: true,
