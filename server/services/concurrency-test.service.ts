...
export interface DeadlockTestResult {
  success: boolean;
  message: string;
  produto1: { id?: number; estoque?: unknown } | null;
  produto2: { id?: number; estoque?: unknown } | null;
}
 ...
 * APENAS PARA TESTES - NÃO USAR EM PRODUÇÃO
 */
export async function testDeadlock(produtoId1: number, produtoId2: number): Promise<DeadlockTestResult> {
