 ...
 */
function containsMaliciousPatterns(input: string): { detected: boolean; type: string; pattern: RegExp } {
 ...
 */
function hasSuspiciousQuery(queryString: string): boolean {
 ...
 */
function checkFloodLimits(req: Request): { valid: boolean; reason?: string } {
