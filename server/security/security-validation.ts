 ...
 */
function validateRequestSize(req: Request): { valid: boolean; reason: string } {
 ...
 */
function validateRequestPath(req: Request): { valid: boolean; reason: string } {
  const path = req.path;
 ...
 * Valida Content-Type
 */
function validateContentType(req: Request): { valid: boolean; reason: string } {
