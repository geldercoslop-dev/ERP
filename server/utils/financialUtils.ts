 ...
 */
export function sumWithPrecision(values: number[]): number {
 ...
 */
export function subtractWithPrecision(value: number, subtract: number): number {
 ...
 */
export function multiplyWithPrecision(a: number, b: number): number {
 ...
 */
export function applyDiscount(value: number, discount: number): number {
 ...
 */
export function applyDiscountPercent(value: number, discountPercent: number): number {
 ...
 */
export function applyTax(value: number, taxRate: number): number {
